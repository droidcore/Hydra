...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_FLASH)
extern struct cpufreq_governor cpufreq_gov_flash;
#define CPUFREQ_DEFAULT_GOVERNOR        (&cpufreq_gov_flash)
>>>>>>> 9a2e8be... drivers: cpufreq: add Flash governor
#endif
